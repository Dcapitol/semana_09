...
public class Propuesto_09_1 extends JFrame implements ActionListener {
	...
	protected void actionPerformedBtnReportar(ActionEvent arg0) {
		...
		imprimir("Suma de Importes :  " + af.sumaImportesFacturados());
		imprimir("Importe Promedio :  " + af.importeFacturadoPromedio());
		imprimir("Mayor importe :  " + af.mayorImporteFacturado());
		imprimir("Empresa con importe facturado menor al promedio :  " + af.empresaMenorQuePromedio());
